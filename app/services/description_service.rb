class DescriptionService
  ...
  def desc_open_ps
    <<~DESCR.squeeze(' ').chomp
      ...
      <ul>
          <li>🇷🇺 Русский голос: #{@game.rus_voice ? 'Есть' : 'Нет'}</li>
      ...
      <p>#️⃣Теги: рlаystаtiоn рlus, рs+, рs рlus, Подписка РSN, Подписка, Рlаystаtiоn 12 месяцев, подписка рs рlus, 
  ...
  def desc_open_ps_store
    <<~DESCR.squeeze(' ').chomp
      ...
      <p>🇷🇺 Русское меню и текст: #{@game.rus_screen ? 'Есть' : 'Нет'}</p> 
      
      <p>🎮 Платформа: #{@game.platform}</p>
  
      <p>Цена указана с учетом февральской акции! Предложение актуально до 31 марта!</p>
      <p>Наша команда <strong>«OPEN PS STORE»</strong> занимается оформлением игр и подписок более 3-х лет.</p>
      <p>Работаем каждый день с 09:00 до 23:30 по Московскому времени.</p>

      <ul>
          <li>⭐️ Быстрое оформление, от 3 минут</li>
          <li>⭐️ Более 3000 отзывов</li>
          <li>⭐️ Гарантия от блокировки</li>
      </ul>
      
      <p>Напишите нам и мы оформим Вам игру на вашу приставку, все что Вам останется - это скачать игру и 
      насладиться процессом.</p>
      
      <p>Подпишитесь на наш профиль, там вы сможете найти много интересных игр по самым низким ценам</p>
      
      <p>#️⃣ Теги: рlаystаtiоn рlus, рs+, рs рlus, Подписка РSN, Подписка, Рlаystаtiоn 12 месяцев, подписка рs рlus, 
      подписка рs, рlаystаtiоn+, рs+, рs+ 12 месяцев, подписка рs рlus, рs stоrе, рlаy, псн Турция, stаtiоn stоrе, 
      игры для рs4, рs4, рs5, 4, 5, игра для приставки, подписка, Подписка на год, месяц, подписка ехtrа, подписка 
      dеluхе, Экстра, Делюкс, Essential, Extra, Ea Play pro</p>
    DESCR
  ...
  def desc_alexander
    <<~DESCR.squeeze(' ').chomp
      ...
      <p>#️⃣ Теги: рlаystаtiоn рlus, рs+, рs рlus, Подписка РSN, Подписка, Рlаystаtiоn 12 месяцев, подписка рs рlus, 
      подписка рs, рlаystаtiоn+, рs+, рs+ 12 месяцев, подписка рs рlus, рs stоrе, рlаy, псн Турция, stаtiоn stоrе, 
      игры для рs4, рs4, рs5, 4, 5, игра для приставки, подписка на год, месяц, подписка ехtrа, подписка dеluхе, 
      Экстра, Делюкс, Essential, Extra, Ea Play pro</p>
    DESCR
  end
end
